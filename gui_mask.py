...
Title_Label = Label(Tops,font=('Comic Sans MS',20,'bold'),text = "    'Mask Prediction On Image' \n\t   using NLP-Machine Learning\t\t",pady=9,bg= 'white',fg='red',justify ="center")
...
Label_1 =Label(MainFrame, font=('lato black', 17,'bold'), text="\tDetect MASK using Image face",padx=2,pady=2, bg="white",fg ="black")
